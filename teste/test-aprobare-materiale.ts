...
const MIXT = P([rand('M1', 'Carne vita', 800), rand('U1', 'TRICOU CREW L', 90, 'UNIFORMA CREW & MANAGERI'), rand('B1', 'Toner', 300, 'Birotica'), rand('P9', 'Cutie burger', 50, 'PAPER'), rand('X9', 'Abonament curierat', 40, 'Servicii externe')]);   // o categorie fără regulă; tot vocabularul FRYDAY are decizie
