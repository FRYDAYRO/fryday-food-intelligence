...
const MIXT = P([rand('M1', 'Carne vita', 800), rand('U1', 'TRICOU CREW L', 90, 'UNIFORMA CREW & MANAGERI'), rand('B1', 'Toner', 300, 'Birotica'), rand('P9', 'Cutie burger', 50, 'PAPER'), rand('X9', 'Cutie Jucarie', 40, 'Toys')]);   // Toys e singura categorie FRYDAY fără decizie (Alcool intră în FC Curat din 06.09.2026)
...
t('categoria neclasificată („Toys") e semnalată, nu pusă în coadă', r7.rezultat.diagnostice.some(d => d.cod === 'CATEGORIE_NECUNOSCUTA' && d.exemple.includes('Toys')) && !c7.includes('X9'));
